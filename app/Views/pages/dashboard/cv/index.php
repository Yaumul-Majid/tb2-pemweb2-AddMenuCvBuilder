            ...
            <div class="form-group">
              <div class="row ">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" name="address" placeholder="Enter Your Address" value="">
                </div>
                <div class="col-md-3">
                  <label class="font-weight-bold">Post Code : </label>
                  <input type="text" class="form-control" name="post_code" placeholder="Enter Your Post Code" value="">
                </div>
                <div class="col-md-3">
                  <label class="font-weight-bold">Division : </label>
                  <input type="text" class="form-control" name="division" placeholder="Enter Your Division" value="">
                </div>
              </div>
            </div>
            <div class="form-group">
